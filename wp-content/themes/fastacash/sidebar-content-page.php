...
<?php if (have_posts()) : ?>
        ...
        <div class="navigation">
			<div class="previous"><?php next_posts_link( __( '&#8249; Older posts', 'responsive', 'in_same_cat' ) ); ?></div>
            <div class="next"><?php previous_posts_link( __( 'Newer posts &#8250;', 'responsive' , 'in_same_cat') ); ?></div>
